...
function AlertDialogAction({
  className,
  ...props
}: Omit<React.ComponentProps<typeof AlertDialogPrimitive.Close>, "className"> & { className?: string }) {
  return <AlertDialogPrimitive.Close className={buttonVariants({ className })} {...props} />;
}
...
function AlertDialogCancel({
  ...
  return <AlertDialogPrimitive.Close className={buttonVariants({ variant: "outline", className })} {...props} />;
}
