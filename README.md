...
6. In Convex you'd also need to setup `OPENCODE_API_KEY` with your [OpenCode Zen](https://opencode.ai/docs/zen) key: `npx convex env set OPENCODE_API_KEY <your_key>`.
